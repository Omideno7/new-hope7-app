...
allowed={'js/app.js','js/nh7-app-enhancements-v230.js','js/nh7-my-notes-v234.js','js/nh7-apocrypha-v270.js','js/nh7-reader-toolbar-v452.js','js/nh7-my-notes-categories-v452.js','js/nh7-theme-studio-v453.js','js/nh7-original-language-v453.js','js/nh7-fonts-v454.js','js/nh7-audio-quick-bible-v454.js'}
...
s=s.replace('<main id="view"','<aside class="nh7-study-preview-banner453" dir="rtl"><strong>Study Preview 4.5.4</strong><br>نسخهٔ آزمایشی مستقل؛ یادداشت‌ها و تنظیمات حساب اصلی در این صفحه تغییر نمی‌کنند.<br><button type="button" data-go="settings">🎨 ظاهر / Theme Studio / Izgled</button></aside>\n<main id="view"')
