...
const VERSION='v2.3.9.19-apocrypha-exact-books';
...
function isProtectedSupabase(url){return url.origin==='https://gpzcwffxnddhaeaogdyo.supabase.co'&&(
  /\/rest\/v1\/(sermons|audio_bible_books|audio_bible_books_v220|audio_bible_chapters|audio_bible_chapters_v220|nh7_library_items|nh7_library_items_v222|nh7_library_items_v224|rpc\/nh7_apocrypha_)/.test(url.pathname)
