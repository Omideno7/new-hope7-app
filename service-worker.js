...
const CORE_ASSETS=[
  './','./index.html','./admin.html','./certificate.html','./verify-document.html','./reset-password.html','./privacy.html','./css/styles.css','./css/v2.2.0.css','./css/v2.2.0-platform.css','./css/v2.2.1.css','./css/v2.2.2.css','./css/v2.2.3.css','./css/v2.2.4.css','./css/v2.2.5.css','./css/v2.3.0-protected-bible.css','./js/app.js','./js/app-v2.3.0-protected-bible.js','./js/admin-v2.2.0.js','./js/admin-v2.2.1.js','./js/admin-v2.2.2.js','./js/admin-v2.2.3.js','./js/admin-v2.2.4.js','./js/admin-v2.2.5.js','./manifest.json','./admin-manifest.json',
...
// Never cache authenticated school/audio/library/meeting responses in a shared
// URL-only cache. Only genuinely public, non-personal endpoints belong here.
function isPublicSupabase(url){if(!url.pathname.includes('/rest/v1/'))return false;return ['daily_content','notification_settings'].some(t=>url.pathname.includes('/rest/v1/'+t))}
