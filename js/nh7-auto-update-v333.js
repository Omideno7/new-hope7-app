/* New Hope 7 v3.3.6 — semantic updates + School Audio guard + iPhone lesson hotfix loader */
(()=>{'use strict';
...
function loadSchoolHotfix(){if(window.NH7_SCHOOL_IOS_HOTFIX_VERSION||document.querySelector('script[data-nh7-school-ios-hotfix]'))return;const script=document.createElement('script');script.dataset.nh7SchoolIosHotfix='1';script.src=new URL('./js/nh7-school-ios-hotfix-v335.js?v=2.3.9.34-hotfix2',document.baseURI||location.href).href;script.async=false;script.onerror=()=>console.warn('NH7 School iPhone hotfix did not load');document.head.appendChild(script)}
...
loadSchoolHotfix();boot();window.NH7_AUTO_UPDATE_VERSION='3.3.6';
})();
