/* New Hope 7 v3.3.3 — silent direct-shell updates; preserve offline media */
(()=>{'use strict';
...
window.addEventListener('pageshow',()=>setTimeout(check,900));document.addEventListener('visibilitychange',()=>{if(!document.hidden)setTimeout(check,650)});window.addEventListener('online',()=>setTimeout(()=>{boot();check()},500));boot();window.NH7_AUTO_UPDATE_VERSION='3.3.3';
})();
