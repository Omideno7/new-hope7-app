/* New Hope 7 v3.3.2 — stable service-worker registration and safe updates */
(()=>{'use strict';
const BUILD='2.3.9.32';
...
window.addEventListener('pageshow',()=>setTimeout(check,900));document.addEventListener('visibilitychange',()=>{if(!document.hidden)setTimeout(check,650)});window.addEventListener('online',()=>setTimeout(()=>{boot();check()},500));boot();window.NH7_AUTO_UPDATE_VERSION='3.3.2';
})();
