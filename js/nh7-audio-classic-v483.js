/* New Hope 7 — classic signed audio player v4.8.3
 *
...
let audio=null,current=null,currentPanel=null,patchTimer=0,prewarmBusy=false,nowPlayingBar=null,playQueue=[],queueIndex=-1,queueBusy=false;
...
function ensureNowPlaying(){
  ...
  bar.className='nh7-now-playing-v482';
  bar.hidden=true;
  bar.setAttribute('aria-live','polite');
  bar.innerHTML=`<button type="button" class="nh7-now-open-v482" data-now-open><span class="nh7-now-icon-v482">🎧</span><span class="nh7-now-copy-v482"><strong data-now-title></strong><small data-now-time></small></span></button><div class="nh7-now-actions-v482"><button type="button" data-now-back aria-label="-15">↶15</button><button type="button" data-now-toggle aria-label="Play/Pause">▶</button><button type="button" data-now-forward aria-label="+30">30↷</button><button type="button" data-now-next aria-label="${L('فایل بعدی','Next track','Sljedeća snimka')}">⏭</button></div>`;
...
function syncNowPlaying(){
  ...
  if(!current||!audio||!audio.src){bar.hidden=true;document.body.classList.remove('nh7-has-now-playing-v482');return}
  bar.hidden=false;document.body.classList.add('nh7-has-now-playing-v482');
  const title=bar.querySelector('[data-now-title]'),time=bar.querySelector('[data-now-time]'),toggle=bar.querySelector('[data-now-toggle]'),next=bar.querySelector('[data-now-next]');
...
function ensureAudio(){
  ...
  audio=document.createElement('audio');audio.preload='metadata';audio.setAttribute('playsinline','');audio.setAttribute('webkit-playsinline','');audio.dataset.nh7ClassicAudioEngine='1';audio.hidden=true;document.body.appendChild(audio);
...
.nh7-now-playing-v482{position:fixed;left:12px;right:12px;bottom:calc(74px + env(safe-area-inset-bottom,0px));z-index:1200;display:flex;align-items:center;gap:10px;padding:9px 10px;border:1px solid var(--line,#d9e6f7);border-radius:16px;background:var(--card,#ffffff);color:var(--text,#062444);box-shadow:0 10px 28px rgba(0,0,0,.18);backdrop-filter:blur(16px)}
.nh7-now-playing-v482[hidden]{display:none!important}.nh7-now-open-v482{min-width:0;flex:1;display:flex;align-items:center;gap:9px;border:0;background:transparent;color:inherit;text-align:start;padding:0;cursor:pointer}.nh7-now-icon-v482{width:38px;height:38px;display:grid;place-items:center;border-radius:12px;background:var(--soft,#eef7ff);font-size:18px}.nh7-now-copy-v482{min-width:0;display:flex;flex-direction:column;gap:2px}.nh7-now-copy-v482 strong{max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:.86rem}.nh7-now-copy-v482 small{font-size:.72rem;opacity:.72;font-variant-numeric:tabular-nums}.nh7-now-actions-v482{display:flex;align-items:center;gap:5px}.nh7-now-actions-v482 button{width:38px;height:38px;border:1px solid var(--line,#d9e6f7);border-radius:12px;background:var(--soft,#eef7ff);color:inherit;font-weight:800;cursor:pointer}.nh7-now-actions-v482 button[data-now-toggle]{width:42px;height:42px;border-radius:50%;background:var(--accent,#0476d9);color:#fff;border:0}.nh7-now-actions-v482 button:disabled{opacity:.38;cursor:default}.nh7-now-actions-v482 button[data-now-next]{font-size:1rem}.nh7-has-now-playing-v482 #view{padding-bottom:calc(155px + env(safe-area-inset-bottom,0px))!important}@media(max-width:420px){.nh7-now-playing-v482{left:8px;right:8px;gap:6px;padding:8px}.nh7-now-actions-v482 button{width:34px;height:34px}.nh7-now-actions-v482 button[data-now-toggle]{width:38px;height:38px}.nh7-now-icon-v482{width:34px;height:34px}}
...
window.NH7_AUDIO_CLASSIC_VERSION='4.8.3';
window.NH7_AUDIO_SIGNED_VERSION='4.6.1-401-refresh';
window.NH7_AUDIO_CLASSIC_V400={patch,prewarm,playItem,playNextTrack,playPreviousTrack,downloadItem,clearAll,getState:()=>({current,audio,playQueue:[...playQueue],queueIndex}),openCurrentAudio,syncNowPlaying};
