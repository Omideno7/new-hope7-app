...
const CLOUD_ENABLED = !window.NH7_READER_PREVIEW && Boolean(SUPABASE_CONFIG.url && SUPABASE_CONFIG.key);
...
if(!window.NH7_READER_PREVIEW && 'serviceWorker' in navigator) navigator.serviceWorker.register('service-worker.js').catch(console.warn);
