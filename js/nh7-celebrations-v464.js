...
[y+'-01-01','✝️',L('نام‌گذاری عیسی','Holy Name of Jesus','Sveta Marija Bogorodica')],
[y+'-01-06','✨',L('ظهور مسیح','Epiphany','Bogojavljenje')],
[key(plus(e,-46)),'🕊️',L('چهارشنبه خاکستر','Ash Wednesday','Pepelnica')],
[key(plus(e,-7)),'🌿',L('یکشنبه نخل','Palm Sunday','Cvjetnica')],
[key(plus(e,-3)),'🍞',L('پنجشنبه مقدس','Maundy Thursday','Veliki četvrtak')],
[key(plus(e,-2)),'✝️',L('جمعه نیک','Good Friday','Veliki petak')],
[key(plus(e,-1)),'🕯️',L('شنبه مقدس','Holy Saturday','Velika subota')],
[key(e),'🌅',L('عید قیام مسیح','Easter Sunday','Uskrs')],
[key(plus(e,1)),'🌅',L('دوشنبه عید پاک','Easter Monday','Uskrsni ponedjeljak')],
[key(plus(e,39)),'☁️',L('عید صعود','Ascension','Uzašašće')],
[key(plus(e,49)),'🔥',L('پنطیکاست','Pentecost','Duhovi')],
[key(plus(e,50)),'🔥',L('دوشنبه پنطیکاست','Pentecost Monday','Duhovski ponedjeljak')],
[y+'-11-01','🕯️',L('روز همه مقدسین','All Saints’ Day','Svi sveti')],
[y+'-12-24','🕯️',L('شب میلاد','Christmas Eve','Badnjak')],
[y+'-12-25','⭐',L('میلاد عیسی مسیح','Christmas','Božić')],
[y+'-12-26','✝️',L('روز استیفان مقدس','St Stephen’s Day','Sveti Stjepan')]
];const x=rows.find(r=>r[0]===today);return x?{key:today,icon:x[1],title:x[2]}:null}
