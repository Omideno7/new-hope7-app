/* New Hope 7 v3.2.8 — stable service-worker registration and safe updates */
(()=>{'use strict';
const BUILD='2.3.9.28';
const VERSION_URL='./version.json';
const WORKER='./sw-offline-v328.js';
...
window.addEventListener('pageshow',()=>setTimeout(check,500));
document.addEventListener('visibilitychange',()=>{if(!document.hidden)setTimeout(check,350)});
window.addEventListener('online',()=>setTimeout(()=>{boot();check()},300));
boot();
window.NH7_AUTO_UPDATE_VERSION='3.2.8';
})();
