...
(()=>{'use strict';
if(window.__NH7_AUDIO_MINIPLAYER_V485__)return;
window.__NH7_AUDIO_MINIPLAYER_V485__=true;

const VERSION='4.8.5-collapsible-miniplayer';
...
window.NH7_AUDIO_MINIPLAYER_V485={sync,setExpanded,get expanded(){return expanded}};
})();