...
const CLOUD_ENABLED = !window.NH7_NAVIGATION_PREVIEW && Boolean(SUPABASE_CONFIG.url && SUPABASE_CONFIG.key);
...
if(!window.NH7_NAVIGATION_PREVIEW && 'serviceWorker' in navigator) navigator.serviceWorker.register('service-worker.js').catch(console.warn);
