...
new MutationObserver(()=>{clearTimeout(timer);timer=setTimeout(patch,80)}).observe(document.documentElement,{childList:true,subtree:true});window.addEventListener('pageshow',patch);addStyle();patch();openShared();window.NH7_SERMON_SOCIAL_VERSION='4.4.2';
})();
