...
const TXT={
  fa:{
    ...
    privacy:'برای حفظ حریم خصوصی بهتر است فقط نام کوچک یا نام مستعار و اطلاعات ضروری را ثبت کنید. اطلاعات این بخش برای پیگیری شخصی شماست.',
  ...
  en:{
    ...
    privacy:'For privacy, use a first name or nickname and record only what is necessary. This information is for your personal follow-up.',
  ...
  hr:{
    ...
    privacy:'Radi privatnosti koristite ime ili nadimak i zapisujte samo nužne podatke. Ove informacije služe vašem osobnom praćenju.',
