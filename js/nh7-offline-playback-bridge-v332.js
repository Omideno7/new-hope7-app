/* New Hope 7 v3.3.2 — offline-only playback bridge; online playback keeps the real user gesture */
(()=>{'use strict';
const VERSION='3.3.2-offline-only-playback-bridge';
...
async function handle(event){
  ...
  /* Critical: never intercept a real online click. Safari/iOS needs the original trusted
     user gesture to reach HTMLMediaElement.play(). */
